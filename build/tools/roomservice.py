...
custom_local_manifest = ".repo/local_manifests/zenith.xml"
custom_default_revision = "15"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'fourteen')
custom_dependencies = "zenith.dependencies"
org_manifest = "Project-Zenith-Devices"  # leave empty if org is provided in manifest
org_display = "Project-Zenith-Devices"  # needed for displaying
